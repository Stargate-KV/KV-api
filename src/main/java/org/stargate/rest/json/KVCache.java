...
public class KVCache {
  ...
  public KVCache() {
    ...
    this.maxSlots =
        1000; // (int)(freeMemory * 0.8 / (128 * 1024)); // Allocate 80% of the memory, max size of
    // slots is 128KB
    ...
    // System.out.println("The freememory size: " + freeMemory + ". The number of slots we
    // allocated: " + this.maxSlots);
  }
