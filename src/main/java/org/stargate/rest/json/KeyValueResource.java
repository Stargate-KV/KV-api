...
public class KeyValueResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public KeyValPair getKeyVal(@PathParam("db_id")Integer db_id, KeyValPair kvPair) throws KvstoreException {
    ...
    @Path("{db_id}/key")
    @Consumes(MediaType.APPLICATION_JSON)
    public void deleteKey(@PathParam("db_id")Integer db_id, KeyValPair kvPair) throws KvstoreException  {
    	if (db_id == null || kvPair == null || kvPair.key == null || kvPair.value != null) {
    		throw new KvstoreException(400, "bad request");
    	}
